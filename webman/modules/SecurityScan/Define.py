...
MAIN_SCANNER_PIDFILE		= "/var/run/synosecurityscan.pid"
MAIN_UPDATE_PIDFILE			= "/var/run/synosecurityScanUpdate.pid"
...
DB_URL						= "https://global.download.synology.com/download/securityscan/%s/%s/securityscan-db.tgz.gpg"
UPDATE_SOCKET_TIMEOUT		= 30
DB_PATH_TMP					= SECURITY_DB_PREFIX + "ruleDB.new"
DB_DOWNLOAD_SAVE_PATH       = SECURITY_DB_PREFIX + "securityscan-db.tgz.gpg"
DB_PATH_TAR_TMP				= SECURITY_DB_PREFIX + "securityscan-db.tgz"
...
#FIXME: should get when build time
SYNOSDK_LIBRARY_PATH		= "/lib/libsynosdk.so.5"
...
ALL_CATEGORY				= [CATEGORY_UPDATE, CATEGORY_USERINFO, CATEGORY_MALWARE, CATEGORY_NETWORK, CATEGORY_SECURITY_SETTING]
...
S01                       = "/usr/syno/etc/rc.d/S01iptables.sh"
NETSTAT                   = "/bin/netstat"
BUFSIZ                    = 4096
